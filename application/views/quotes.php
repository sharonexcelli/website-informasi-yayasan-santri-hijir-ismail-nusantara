    ...
    <section class="slice slice-lg bg-section-secondary">
        <div class="container">
            <div class="row justify-content-between align-items-center mb-5">
                <div class="col">
                    <h5 class="mb-1">Profile Pengajar</h5>
                    ...
                    <div class="actions">
                        ...
                        <div class="dropdown mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(21px, 35px, 0px);">
                                <a class="dropdown-item <?=$this->input->get('sort')==1?'active':''?>" href="<?=base_url('profile-alumni?query='.$this->input->get('query').'&sort=1')?>">
                                    <i class="fa fa-sort-amount-down"></i>Newest
                                </a>
                                <a class="dropdown-item <?=$this->input->get('sort')==2||$this->input->get('sort')==''?'active':''?>" href="<?=base_url('profile-alumni?query='.$this->input->get('query').'&sort=2')?>">
                                    <i class="fa fa-sort-amount-up"></i>Oldest
                                </a>
                                <a class="dropdown-item <?=$this->input->get('sort')==3?'active':''?>" href="<?=base_url('profile-alumni?query='.$this->input->get('query').'&sort=3')?>">
                                    <i class="fa fa-sort-alpha-down"></i>From A-Z
                                </a>
                                <a class="dropdown-item <?=$this->input->get('sort')==4?'active':''?>" href="<?=base_url('profile-alumni?query='.$this->input->get('query').'&sort=4')?>">
                            ...
                            <div class="row">
                                <div class="col text-center">
                                    <ul class="list-inline mb-0">
                                        ...
                                        <li class="list-inline-item pr-4">
                                            <a href="#" class="text-muted copytext" data-text="<?=base_url('quprofile-alumniotes/detail/'.$value['slug'])?>"><i class="fas fa-link mr-1 text-muted"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
