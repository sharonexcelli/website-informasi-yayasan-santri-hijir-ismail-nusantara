    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-md-6 col-6 d-flex align-items-center justify-content-between justify-content-md-start">
            <div class="d-inline-block">
                <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">Term & Condition</h5>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="<?=base_url('cms/terms/edit/'.$v['id'])?>" class="btn btn-xs btn-primary btn-icon rounded-pill">
...
<div class="modal fade" id="modalUpdateStatus" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form class="modal-content" action="<?php echo base_url('cms/terms/save'); ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="modalUpdateData" tabindex="-1" role="dialog" data-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form class="modal-content" action="<?php echo base_url('cms/terms/update'); ?>" id="updateb" method="post" enctype="multipart/form-data">
...
<script>
    ...
    $(function () {
        $('.publishb').click(function(e){
            ...
            // console.log(status) 
            $.ajax({
                url: "<?php echo base_url('cms/terms/publish'); ?>",
                type: "post",
                data: {
                    id: id,
                    status: !status?1:0
            ...
            MessageBox.confirm({
                ...
                callback: function(btn) {
                    if(btn === "Y") {
                        ...
                        $.ajax({
                            url: "<?php echo base_url('cms/terms/delete'); ?>",
                            type: "post",
                            data: {id: id},
                            dataType: "json",
                            success: function (resp) {
        ...
        $('#updateb').submit(function(e){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('cms/terms/update'); ?>",
                cache: false,
                contentType: false,
                processData: false,
                data: formData,
