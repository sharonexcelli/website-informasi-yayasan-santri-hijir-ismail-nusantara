                ...
                <div class=" col-lg-12">
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-md-5 mb-4 mb-md-0">
                            <span class="h2 mb-0 text-white d-block mt-3">Pengurus Wilayah <?=$province_active['name']?></span>
                        ...
                        <div class="btn-group btn-group-nav shadow ml-auto" role="group" aria-label="Basic example">
                            ...
                            <div class="btn-group" role="group">
                                <button id="btn-group-boards" type="button" class="btn btn-neutral btn-icon" data-toggle="modal" data-target="#modalFilter">
                                    ...
                                    <span class="btn-inner--text d-none d-sm-inline-block">Filter</span>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mb-4">
                <?php 
                    ...
                    foreach ($data as $key => $value) {
                        if(($key>0 && $jbt != $value['position_regional_office']) || ( $key==0)){
                            $jbt = $value['position_regional_office'];
                            $sts = true;
                        }else{
                            $sts = false;
                        }
                    ...
                    <?php
                        ...
                        if($key==0 || $sts){?>
                            <div class="actions-toolbar py-2 mb-4 text-center">
                                <h5 class="mb-1"><?=$value['position_regional_name']?></h5>
                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6">
                                    <div class="card hover-shadow-lg hover-translate-y-n10">
                                        <div class="card-body text-center">
                                            ...
                                            <!-- <span class=" mb-0 " style="font-size: 12px;"><?=$value['position_regional_name']?></span> -->
        ...
        <form class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group fdivw my-none">
                    ...
                    <select name="position" id="fspr" class="form-control" data-toggle="select">
                ...
                <div class="form-group fdivw my-none">
                    ...
                    <select name="location" id="fsppr" class="form-control" data-toggle="select">
...
<script>
    $('document').ready(function(){
        ...
        $('#fspr').val(<?=$this->input->get('position')?>).trigger('change.select2');
        <?php }?>
        <?php if($this->input->get('location')!=''){?>
        $('#fsppr').val(<?=$this->input->get('location')?>).trigger('change.select2');
        <?php } else {?>
        $('#fsppr').val(31).trigger('change.select2');
        <?php }?>
    })
</script>
